var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_-e4e15063.js"
	},
	{
		type: "script",
		href: "/assets/entry-client-797ff6cf.js"
	},
	{
		type: "style",
		href: "/assets/entry-client-ca6e3725.css"
	}
],
	"/about": [
	{
		type: "script",
		href: "/assets/about-90a58f3d.js"
	},
	{
		type: "script",
		href: "/assets/entry-client-797ff6cf.js"
...
function toObjectKey(name) {
  ...
  return invalidIdentifierPos === -1 ? name : quote$1(name, invalidIdentifierPos);
}
...
function ssrElement(tag, props, children, needsId) {
  ...
  for (let i = 0; i < keys.length; i++) {
    ...
    if (ChildProperties.has(prop)) {
      if (children === undefined && !skipChildren) children = prop === "innerHTML" ? props[prop] : escape$1(props[prop]);
      continue;
    }
...
function getAssetsFromManifest(manifest, routerContext) {
  ...
  const links = match.reduce((r, src) => {
    r[src.href] = src.type === "style" ? ssr(_tmpl$$5, ssrHydrationKey(), ssrAttribute("href", escape$1(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2, ssrHydrationKey(), ssrAttribute("href", escape$1(src.href, true), false)) : undefined;
    return r;
  }, {});
...
function NotFound() {
  return ssr(_tmpl$$4, ssrHydrationKey(), escape$1(createComponent(A, {
    href: "/",
    "class": "text-sky-600 hover:underline",
    children: "Home"
  })), escape$1(createComponent(A, {
    href: "/about",
    "class": "text-sky-600 hover:underline",
    children: "About Page"
  })));
...
const _tmpl$$3 = ["<main", " class=\"text-center mx-auto text-gray-700 p-4\"><h1 class=\"max-6-xs text-left text-3xl text-sky-700 font-thin uppercase mb-2\">About Page</h1><button class=\"bg-gray-200 active:bg-gray-300 px-6 py-2\">ACTION</button><div id=\"place\"></div></main>"];
function About() {
...
function Counter() {
  ...
  return ssr(_tmpl$$2, ssrHydrationKey(), escape$1(count()));
}

const _tmpl$$1 = ["<main", " class=\"text-center- mx-auto text-gray-700 p-4\"><h1 class=\"max-6-xs text-6xl text-sky-700 font-thin uppercase my-16\">Hello world!</h1><p class=\"-mt-8 mb-4\">ENV <!--#-->", "<!--/--></p><!--#-->", "<!--/--><p class=\"mt-8\">Visit <a href=\"https://solidjs.com\" target=\"_blank\" class=\"text-sky-600 hover:underline\">solidjs.com</a> to learn how to build Solid apps.</p><p class=\"my-4\"><span>Home</span> - <!--#-->", "<!--/--> </p></main>"];
function Home() {
  useRouteData();
  // console.log(countries())
  return ssr(_tmpl$$1, ssrHydrationKey(), escape$1(process.env.MY_VAR), escape$1(createComponent(Counter, {})), escape$1(createComponent(A, {
    href: "/about",
    "class": "text-sky-600 hover:underline",
    children: "About Page"
  })));
...
const _tmpl$ = ["<nav", " class=\"bg-blue-500\"><ul class=\"container flex items-center p-3 text-gray-200\"><li class=\"", "\">", "</li><li class=\"", "\">", "</li></ul></nav>"];
function Navbar() {
  const location = useLocation();
  const active = path => path == location.pathname ? "border-blue-800" : "border-transparent hover:border-blue-800";
  return ssr(_tmpl$, ssrHydrationKey(), `border-b-2 ${escape$1(active("/"), true)} mx-1.5 sm:mx-6`, escape$1(createComponent(A, {
    href: "/",
    children: "Home"
  })), `border-b-2 ${escape$1(active("/about"), true)} mx-1.5 sm:mx-6`, escape$1(createComponent(A, {
    href: "/about",
    children: "About"
  })));
}
